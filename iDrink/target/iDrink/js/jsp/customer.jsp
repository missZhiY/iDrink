...
<div id="wrapper">
  ...
  <nav class="navbar navbar-default navbar-static-top" role="navigation"
	...
	<div class="navbar-header">
		<a class="navbar-brand" href="<%=basePath%>customer/list.action">BOOT客户管理系统 v3.0</a>
	</div>
	<!-- 导航栏右侧图标部分 -->
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<table class="table table-bordered table-striped">
						...
						<tbody>
							<c:forEach items="${page.rows}" var="from">
								<tr>
									<td>${from.cust_id}</td>
									<td>${from.cust_name}</td>
									<td>${from.cust_source}</td>
									<td>${from.cust_industry}</td>
									<td>${from.cust_level}</td>
									<td>${from.cust_phone}</td>
								    <td>${from.cust_mobile}</td>
									<td>
										<a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#customerEditDialog" onclick= "editCustomer(${from.cust_id})">修改</a>
										<a href="#" class="btn btn-danger btn-xs" onclick="deleteCustomer(${from.cust_id})">删除</a>
									</td>
								</tr>
							</c:forEach>
						</tbody>
